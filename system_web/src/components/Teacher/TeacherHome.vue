...
<script>
import AsideTeacher from "@/components/Others/AsideTeacher.vue";
import HeaderTeacher from "@/components/Others/HeaderTeacher.vue";
import TabTeacher from "@/components/Others/TabTeacher.vue";
export default {
  name: "TeacherHome",
  data() {
    return{
